module.exports = Object.freeze({
    ...
    SONGS: {
      ...
      SONG7: ['C', 'D', 'Ds', 'G', 'F', 'Ds', 'F', 'Ds', 'D', 'D', 'D', 'D', 'D', 'Ds', 'D', 'C', 'C', 'D', 'Ds', 'G', 'F', 'Ds', 'F', 'Ds', 'D', 'D', 'D', 'D', 'D', 'Ds', 'D', 'C', 'G', 'G', 'G', 'F', 'F', 'Ds', 'F', 'Ds', 'F', 'Ds']
    },
    NUM_PLAYERS_MAX: 6,
    EASY: 4,
    MEDIUM: 6,
    ...
    MSG_TYPES: {
      ...
      CREATE_SOLO_GAME_REQUEST: 'create_solo_game',
      CREATE_GAME_SUCCESS: 'create_game_success',
      CREATE_SOLO_GAME_SUCCESS: 'create_solo_game_success',
